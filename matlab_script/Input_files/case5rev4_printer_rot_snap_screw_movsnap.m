cp1 =[5.4519   18.0000    3.3944 -1 0 -1];
cp2 =[10.299 2.5 0.125 0 0 -1];
cp3 =[2.375 18 4.045 1 0 -1];
cp4 =[2.375 0 4.045 1 0 -1];
cp5 =[5.4519   0    3.3944 -1 0 -1];
cp6=[8.625 13.875 1.744 0.841,0,0.541];
cp7=[8.625 13.875 1.744 -0.841,0,-0.541];
cp8=[8.625 4.125 1.744 0.841,0,0.541];
cp9=[8.625 4.125 1.744 -0.841,0,-0.541];
cp10=[0.322 14.75 4.25 0.541,0,-0.841];
cp11=[0.322 14.75 4.25 -0.541,0,0.841];
cp12=[0.322 3.25 4.25 0.541,0,-0.841];
cp13=[0.322 3.25 4.25 -0.541,0,0.841];
cpin1=[8.625 13.875 1.744 0.841,0,0.541];
cpin2=[8.625 4.125 1.744 0.841,0,0.541];
cpin3=[0.322 14.75 4.25 0.541,0,-0.841];
cpin4=[0.322 3.25 4.25 0.541,0,-0.841];
