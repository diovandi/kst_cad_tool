...
cp6=[8.625 13.875 1.744 .5 0 .5];
cp7=[8.625 13.875 1.744 -.5 0 -.5];
cp8=[8.625 4.125 1.744 .5 0 .5];
cp9=[8.625 4.125 1.744 -.5 0 -.5];
cp10=[0.322 14.75 4.25 -.5 0 .5];
cp11=[0.322 14.75 4.25 .5 0 -.5];
cp12=[0.322 3.25 4.25 -.5 0 .5];
cp13=[0.322 3.25 4.25 .5 0 -.5];
cpin1=[8.625 13.875 1.744 .5 0 .5];
cpin2=[8.625 4.125 1.744 .5 0 .5];
cpin3=[0.322 14.75 4.25 .5 0 .5];
cpin4=[0.322 3.25 4.25 .5 0 .5];
