...
cp3 =[2.375 18 2.045 0 0 -1];
cp4 =[2.375 0 2.045 0 0 -1];
...
cp10=[0.322 14.75 2.25 1 0 0];
cp11=[0.322 14.75 2.25 -1 0 0];
cp12=[0.322 3.25 2.25 1 0 0];
cp13=[0.322 3.25 2.25 -1 0 0];
cpin1=[8.625 13.875 1.744 0 0 1];
cpin2=[8.625 4.125 1.744 0 0 1];
cpin3=[0.322 14.75 2.25 1 0 0];
cpin4=[0.322 3.25 2.25 1 0 0];
clin1=[7.125 18 3.2 1 0 0 0    0    1 8.941];
clin2=[7.125 0 3.2 1 0 0   0    0    1 8.941];
clin3=[1.551 18 2.754 2 0 0.431 -0.2107         0    0.9776 3];
clin4=[1.551 0 2.754 2 0 0.431 -0.2107         0    0.9776 3];
clin5=[0 9 2.42 0 1 0 0 0 1 11.5];
...
% grp_members=[18 19 0 0  0 0 0 0 0 ;
...
% case 5h - 4screw orient + 2 snap angle1d search  (done)
% grp_members=[6 7 14 8 9 15;
%                10 11 16 12 13 17;
%                 1 5 0 0 0 0 ;
%             3 4 0 0 0 0 ];      
% grp_rev_type=[5;5;5;5]; 
% grp_srch_spc=[  0 1 0 ,90;
%                 0 1 0 ,90;
%                 0 1 0 , 60;    
%                 0 1 0 , 60];

% case 5i - Top Line direction and line size of top
% grp_members=[20 ;21 ];      
% grp_rev_type=[7;7]; 
% grp_srch_spc=[  0 0 1, 60;    
%                 0 0 1, 60];

% case 5j- Bottom Line direction and line size of top
% grp_members=[18 ;19 ];      
% grp_rev_type=[7;7]; 
% grp_srch_spc=[  0 0 1, 60;    
%                 0 0 1, 60];

% case5n_epson_sideline_size
% grp_members=[18 19 ;20 21 ];      
% grp_rev_type=[8;8]; 
% grp_srch_spc=[  7 11 ;
%     1 5];
