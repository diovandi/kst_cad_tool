...
cp2 =[9.375 18 0.377 0 0 -1];
cp3 =[10.299 2.5 0.125 0 0 1];
cp4 =[10.299 2.5 0.125 0 0 -1];
cp5 =[2.375 18 4.045 0 0 1];
cp6 =[2.375 18 4.045 0 0 -1];
cp7 =[2.375 0 4.045 0 0 1];
cp8 =[2.375 0 4.045 0 0 -1];
cp9 =[7.5 0 2.125 0 0 1];
cp10 =[7.5 0 2.125 0 0 -1];

cp11=[8.625 13.875 1.744 0 0 1];
cp12=[8.625 13.875 1.744 0 0 -1];
cp13=[8.625 4.125 1.744 0 0 1];
cp14=[8.625 4.125 1.744 0 0 -1];
cp15=[0.322 14.75 4.25 1 0 0];
cp16=[0.322 14.75 4.25 -1 0 0];
cp17=[0.322 3.25 4.25 1 0 0];
cp18=[0.322 3.25 4.25 -1 0 0];

cpin1=[9.375 18 0.377 0 0 1];
cpin2=[10.299 2.5 0.125 0 0 1];
cpin3=[2.375 18 4.045 0 0 1];
cpin4=[2.375 0 4.045 0 0 1];
cpin5=[7.5 0 2.125 0 0 1];

cpin6=[8.625 13.875 1.744 0 0 1];
cpin7=[8.625 4.125 1.744 0 0 1];
cpin8=[0.322 14.75 4.25 1 0 0];
cpin9=[0.322 3.25 4.25 1 0 0];
...
cpin=[cpin1;cpin2;cpin3;cpin4;cpin5;cpin6;cpin7;cpin8;cpin9];
